#
#  Be sure to run `pod spec lint GLDemoUIKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "GrayLand"
  # spec.authors            = { "GrayLand" => "441726442@qq.com" }
  # spec.social_media_url   = "https://twitter.com/GrayLand"
  ...
  #
  # spec.source_files  = "EncryptionDemo/EncryptionLib/*.{h,m}"
  spec.source_files = "GLDemoUIKit/**/*.{h,m,swift}"
